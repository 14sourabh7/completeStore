    ...
    <div id='orders' class="my-5">
        <div class="row">
            ...
            <div class="col-8 mx-auto">
                <input id='searchOrders' class="form-control form-control-dark w-100" type="text" placeholder="Search by order_id or user_id" aria-label="Search">
            </div>
            <div class="col-4">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination paginationOrders">
